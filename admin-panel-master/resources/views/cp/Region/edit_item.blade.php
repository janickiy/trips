...
<form method="post" action="{{URL::to('/')}}/cp/region/edit" autocomplete="off" enctype="multipart/form-data">
{{ csrf_field() }}
...
<option value="{{$country->id}}" @if($item->country_id == $country->id) selected @endif>{{$country->name_ru}}</option>
@empty
@endforelse
</select>
...
<input type="text" name="wiki_entity" value="{{$item->wiki_entity}}" placeholder="{{__('region.wiki_entity')}}" class="form-control input-sm" id="column_wiki_entity"  >

@if($item->wiki_entity != null)
<p><br><a href="https://www.wikidata.org/wiki/{{$item->wiki_entity}}">{{$item->wiki_entity}}</a></p>
@endif
                                </div>
</div>
...
<input type="text" name="name_en" value="{{$item->name_en}}" placeholder="{{__('region.name_en')}}" class="form-control input-sm" id="column_name_en"  >
...
<input type="text" name="name_ru" value="{{$item->name_ru}}" placeholder="{{__('region.name_ru')}}" class="form-control input-sm" id="column_name_ru"  >
...
<div class="modal fade" id="delete_modal" tabindex="-1" role="dialog" aria-labelledby="delete_confirmation" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <h5 class="modal-title" id="delete_confirmation">{{ __('region.delete_confirmation') }}</h5>
      </div>
      <div class="modal-footer">
        <input type="submit" name="delete" class="btn btn-danger" value="{{ __('region.delete') }}">
      </div>
    </div>
  </div>
</div>
