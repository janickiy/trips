...
@section('content_title') Свойства города @endsection
...
@include('cp.formTemplates.text', $param = [
    'label' => 'Введите идентификатор города с префиксом Q:',
    'name' => 'item',
    'value' => '',
    'old_value' => old('item'),
    'placeholder' => 'Q7525',
...
<div class="box box-success" style="position: relative; left: 0px; top: 0px;">
    <div class="box-header ui-sortable-handle">
        <h3 class="box-title">Метод: <span id="method_name">getCityPropertiesV2</span></h3>    
    </div>
