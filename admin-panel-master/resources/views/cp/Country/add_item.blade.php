...
<div class="box-body">
<div class="form-group">
<input type="text" name="wiki_id" value="" placeholder="{{__('country.wiki_id')}}" class="form-control input-sm" id="column_wiki_id" >
</div>
</div>
...
<div class="box-body">
<div class="form-group">
<input type="text" name="wiki_link" value="" placeholder="{{__('country.wiki_link')}}" class="form-control input-sm" id="column_wiki_link">
</div>
</div>
