...
@section('content_title') Страны из Travelpayouts @endsection

@section('content_breadcrumb')
<ol class="breadcrumb">
    <li><a href="{{URL::to("/")}}/cp">{{ __('cp.control_panel') }}</a></li>
    <li class="active">Страны из Travelpayouts:</li>
</ol>
@endsection

@section('content_description')
Здесь отображаются страны, скачанные из Travelpayouts. Только просмотр, нет редактирования. 
@endsection
   ...
   ---->
    ...
    <p>
        <div class="input-group">
            <input placeholder="Поиск стран из Travelpayouts" type="text" name="q" class="form-control" value="{{ app('request')->input('q') }}">
            <span class="input-group-btn">
            <button type="submit" id="search-btn" class="btn btn-success">
                <i class="fa fa-search"></i>
            </button>
            <a href="{{URL::to('/')}}/cp/travelpayouts_countries" id="cancel-search-btn" class="btn btn-danger">
...
<td>
    <a href="{{URL::to("/")}}/cp/travelpayouts_countries/edit/{{$item->id}}">
